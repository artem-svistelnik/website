# Generated by Django 3.1.8 on 2021-04-21 17:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='homepage',
            name='contact_data_email',
            field=models.EmailField(default='example@mail.com', max_length=254, verbose_name='Email для связи'),
        ),
        migrations.AddField(
            model_name='homepage',
            name='contact_data_phone',
            field=phonenumber_field.modelfields.PhoneNumberField(default='+380999999999', max_length=128, region='UA', verbose_name='Контактный номер'),
        ),
        migrations.CreateModel(
